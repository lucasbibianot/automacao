...
//*************** Controle do RF ***********************
#define radioID 2   //Informar "0" para um dispositivo e "1" para o outro dispositivo
...
#if radioID == 2
    RF24 radio(2,15);
    const String ssid = "CLARO_2G6939A3";
    const String wifi_key = "CE6939A3";
...
void setup() {
  ...
  //radio.setPayloadSize(sizeof(tipoDadosRF));
      ...
      int iCont = 1;
      while ( (WiFi.status() != WL_CONNECTED) && (iCont < 100))
      {
          delay(1000);
