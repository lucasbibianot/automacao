        ...
        <main>
            <section>
                <div class="items">
                    ...
                    <div class="content">
                        <span class="dht-labels" id="site_check">%SITE_TESTE%</span>
                        <span id="conectado">%CONECTADO%</span>
                ...
                <div class="items">
                    ...
                    <div class="content">
                        <span class="dht-labels">Tempo Desligamento:</span>
                        <span id="tempo_threshold">%TEMPO_CONFIG%</span>
            ...
            <div class="form">
                <form action="/get">
                    <label>Alterar Tempo : </label>
                    <input type="number" name="input1" placeholder="Digite o tempo em segundos">
                    <input type="text" name="input2" placeholder="Digite o site de check">
    ...
    setInterval(function () {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("conectado").innerHTML = myArr.conectado.valor;
                document.getElementById("site_check").innerHTML = myArr.site_check.valor;
                document.getElementById("tempo_threshold").innerHTML = myArr.tempo_threshold.valor.toFixed(0);
            ...
            <section>
                <div class="form">
                    <form action="/config" method="POST">
                        ...
                        <div class="items">
                            <div class="titulo">
                                <label>Tempo Desligamento: &nbsp;</label>
                            </div>
                            <div class="content">
                                <input class="input_number" type="number" id="tempo_threshold" name="tempo_threshold" placeholder="Tempo em segundos">
                            </div>
                        </div>
                        <div class="items">
                            <div class="titulo">
                        ...
                        <div class="items">
                            <div class="titulo">
                                <label>Site de testes: &nbsp;</label>
                            </div>
                            <div class="content">
                                <input class="input_string" type="string" id="input_site_check" name="input_site_check" placeholder="">
                            </div>
                        </div>                                                
                        <div class="items">
    ...
    function read_config(){
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("tempo_threshold").value = myArr.tempo_threshold;
                ...
                document.getElementById("input_site_check").value = myArr.site_check;               
            }
        };
