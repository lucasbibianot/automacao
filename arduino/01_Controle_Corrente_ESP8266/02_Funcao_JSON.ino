...
String build_msg_json() {
    ...
    JsonObject temp  = msgJson.createNestedObject("corrente");
    temp["valor"] = corrente;
    temp["tipo"] = "M";
    JsonObject temp_config  = msgJson.createNestedObject("corrente_threshold");
    ...
    estadoRele["valor"] = int(digitalRead(pinRele)) == 1 ? "Desligado" : "Ligado";
    estadoRele["tipo"] = "M";  
